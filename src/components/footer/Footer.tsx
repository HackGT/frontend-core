...
const SocialMediaList = [
  new SocialMedia(
    "Instagram",
    "https://www.instagram.com/thehexlabs/",
    FaInstagram
  ),
  new SocialMedia(
    "Facebook",
    "https://www.facebook.com/TheHexLabs",
    FaFacebook
  ),
  new SocialMedia("Twitter", "https://twitter.com/TheHexLabs", FaTwitter),
  new SocialMedia(
    "LinkedIn",
    "https://www.linkedin.com/company/thehexlabs/",
    FaLinkedin
  ),
  ...
  <Container as="footer" textAlign="center" paddingTop={14} paddingBottom={12}>
    <Stack spacing="5">
      ...
      <Box fontSize="14px" color="rgba(100, 100, 100, 0.7)">
        ...
        <Text>
          &copy; {new Date().getFullYear()} HexLabs. All rights reserved.
        </Text>
      </Box>
    </Stack>
  </Container>
